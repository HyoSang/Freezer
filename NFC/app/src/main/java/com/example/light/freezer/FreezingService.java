...
public class FreezingService extends Service {
    ...
    public void onCreate() {
        ...
        mParams = new WindowManager.LayoutParams(
                ...
                WindowManager.LayoutParams.WRAP_CONTENT,30,30,
                WindowManager.LayoutParams.TYPE_SYSTEM_ALERT,					//항상 최 상위에 있게. status bar 밑에 있음. 터치 이벤트 받을 수 있음.
                WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE|WindowManager.LayoutParams.FLAG_LAYOUT_IN_SCREEN,		//이 속성을 안주면 터치 & 키 이벤트도 먹게 된다.
                //포커스를 안줘서 자기 영역 밖터치는 인식 안하고 키이벤트를 사용하지 않게 설정
                PixelFormat.TRANSLUCENT);										//투명
        mParams.gravity = Gravity.TOP| Gravity.START;						//왼쪽 상단에 위치하게 함.
